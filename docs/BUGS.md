...
### Module 4.7
- Roman Hindi queries could return a blank answer when the upstream RAG call failed; added a localized clarification fallback and expanded Roman-Hindi keyword detection to keep Hindi responses working.
